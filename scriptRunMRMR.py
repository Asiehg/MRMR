...
proteintype= "Monomer"                        #Monomer or Trimer
NameofSystem="BRER BtuB_POPC LPS_BtuB"        #Name of the systems
pdbfile ="step5_input.pdb"                    #Name of pdb file


deltatstring=str(deltat)
subprocess.call(['python', 'MRMR.py', NameofSystem , deltatstring, tpr_Name, trajectory_Name, Project_Directory, proteintype , pdbfile  ])
